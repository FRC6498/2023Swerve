...
public class SwerveModule {
    ...
    public SwerveModule(int moduleNumber, SwerveModuleConstants moduleConstants){
        ...
        angleEncoder = new AnalogEncoder(moduleConstants.angleEncoderID);
        configAngleEncoder();
    ...
    private Rotation2d getAngle(){
        return Rotation2d.fromDegrees(angleEncoder.getAbsolutePosition()-angleEncoder.getPositionOffset());
    }
